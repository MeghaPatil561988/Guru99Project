...
public class TestScript04 {
	...
	public Object[][] testData() throws Exception {
		return Util04.getDataFromExcel(Util04.FILE_PATH, Util04.SHEET_NAME,
				Util04.TABLE_NAME);
	}
	...
	public void setUp() throws Exception {
		...
		File pathToBinary = new File(Util04.FIREFOX_PATH);
		FirefoxBinary ffBinary = new FirefoxBinary(pathToBinary);
		FirefoxProfile firefoxProfile = new FirefoxProfile();
		driver = new FirefoxDriver(ffBinary, firefoxProfile);

		// Setting Base URL of website Guru99
		baseUrl = Util04.BASE_URL;
		driver.manage().timeouts()
				.implicitlyWait(Util04.WAIT_TIME, TimeUnit.SECONDS);
	...
	public void testCase04(String username, String password) throws Exception {
	    ...
	    try{ 
			...
			assertEquals(actualBoxMsg,Util04.EXPECT_ERROR);
			
		}    
	    catch (NoAlertPresentException Ex){ 
	    	actualTitle = driver.getTitle();
			// On Successful login compare Actual Page Title with Expected Title
	    	assertEquals(actualTitle,Util04.EXPECT_TITLE);
        } 
	}
