...
public class TestScript02 {
	 ...
	 */
		File pathToBinary = new File(Util02.FIREFOX_PATH);
	...
	driver.manage().timeouts()
		.implicitlyWait(Util02.WAIT_TIME, TimeUnit.SECONDS);
   ...
   public static void main(String[] args) throws Exception {
	...
	//String actualBoxtitle;
	   ...
	   String actualTitle;
	    ...
	    driver.findElement(By.name("uid")).sendKeys(Util02.USER_NAME);  // Enter username

	   
	    driver.findElement(By.name("password")).clear(); // Good practice to clear a field before use
	    driver.findElement(By.name("password")).sendKeys(Util02.PASSWD);  // Enter Password
		...
		if (actualTitle.contains(Util02.EXPECT_TITLE)) 
		{
